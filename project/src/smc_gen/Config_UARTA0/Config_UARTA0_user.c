...
Pragma directive
***********************************************************************************************************************/
#pragma interrupt r_Config_UARTA0_interrupt_send(vect=INTUT0)
#pragma interrupt r_Config_UARTA0_interrupt_receive(vect=INTUR0)
...
* Return Value : None
***********************************************************************************************************************/
static void __near r_Config_UARTA0_interrupt_send(void)
{
...
* Return Value : None
***********************************************************************************************************************/
static void __near r_Config_UARTA0_interrupt_receive(void)
{
    uint16_t temp;
    uint8_t err_type;
