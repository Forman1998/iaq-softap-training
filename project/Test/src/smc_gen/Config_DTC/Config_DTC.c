...
void Start_dtc0(uint8_t * src, uint8_t * dst, uint16_t cnt)
{
	dtc_controldata_0.dtbls = 1U;
	dtc_controldata_0.dtcct = (cnt > 255U) ? 0U : (uint8_t)cnt;
	dtc_controldata_0.dtsar = (uint16_t)src;
	dtc_controldata_0.dtdar = (uint16_t)dst;
